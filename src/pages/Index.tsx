...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary via-secondary to-accent flex items-center justify-center p-4 overflow-hidden relative">
      ...
      <div className="relative">
        <div className="bg-card/95 backdrop-blur-sm rounded-[3rem] shadow-2xl p-8 max-w-sm border-8 border-white/20">
          <div className="flex justify-center mb-6">
            <div className="bg-gradient-to-br from-primary to-secondary rounded-full p-6 shadow-lg">
              <Leaf className="w-16 h-16 text-white" />
            </div>
          </div>

          <h1 className="text-4xl font-black text-center mb-3 bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
            EcoHunt
          </h1>
